...
import Dot from '@fruity/components/@extended/Dot';
...
import { drawerWidth } from '@fruity/config';

// assets
import { ArrowRightOutlined, WindowsOutlined } from '@ant-design/icons';
import backgroundVector from '@fruity/assets/images/mega-menu/back.svg';
import imageChart from '@fruity/assets/images/mega-menu/chart.svg';
