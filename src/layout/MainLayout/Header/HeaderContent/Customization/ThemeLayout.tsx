...
// assets
import defaultLayout from '@fruity/assets/images/customization/default.svg';
import rtlLayout from '@fruity/assets/images/customization/rtl.svg';
import miniMenu from '@fruity/assets/images/customization/mini-menu.svg';
...
const ThemeLayout = () => {
  ...
  const { drawerOpen } = useSelector((state: any) => state.menu) as MenuProps;
