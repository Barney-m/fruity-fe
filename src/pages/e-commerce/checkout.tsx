...
// types
import { CartStateProps, DefaultRootStateProps } from '@fruity/types/cart';
import { Address, TabsProps } from '@fruity/types/e-commerce';

// project imports
import Avatar from '@fruity/components/@extended/Avatar';
import BillingAddress from '@fruity/sections/apps/e-commerce/checkout/BillingAddress';
import Cart from '@fruity/sections/apps/e-commerce/checkout/Cart';
import CartEmpty from '@fruity/sections/apps/e-commerce/checkout/CartEmpty';
import Payment from '@fruity/sections/apps/e-commerce/checkout/Payment';
...
import { getAddresses, editAddress } from '@fruity/store/reducers/product';
import { removeProduct, setBackStep, setBillingAddress, setNextStep, setShippingCharge, setStep, updateProduct } from '@fruity/store/reducers/cart';
