...
// types
import { TabsProps } from '@fruity/types/e-commerce';

// project imports
import FloatingCart from '@fruity/components/cards/e-commerce/FloatingCart';
import ProductFeatures from '@fruity/sections/apps/e-commerce/product-details/ProductFeatures';
import ProductImages from '@fruity/sections/apps/e-commerce/product-details/ProductImages';
import ProductInfo from '@fruity/sections/apps/e-commerce/product-details/ProductInfo';
import ProductReview from '@fruity/sections/apps/e-commerce/product-details/ProductReview';
import ProductSpecifications from '@fruity/sections/apps/e-commerce/product-details/ProductSpecifications';
import RelatedProducts from '@fruity/sections/apps/e-commerce/product-details/RelatedProducts';
import MainCard from '@fruity/components/MainCard';
import { useDispatch, useSelector } from '@fruity/store';
import { getProduct } from '@fruity/store/reducers/product';
