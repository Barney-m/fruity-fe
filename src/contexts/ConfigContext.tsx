...
import useLocalStorage from '@fruity/hooks/useLocalStorage';

// types
import { CustomizationProps, FontFamily, I18n, PresetColor, ThemeDirection, ThemeMode } from '@fruity/types/config';
...
function ConfigProvider({ children }: ConfigProviderProps) {
  const [config, setConfig] = useLocalStorage('fruity-config', initialState);
