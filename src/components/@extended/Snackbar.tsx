...
// types
import { KeyedObject, RootStateProps } from '@fruity/types/root';
import { closeSnackbar } from '@fruity/store/reducers/snackbar';
import { SnackbarProps } from '@fruity/types/snackbar';
...
const Snackbar = () => {
  ...
  const snackbar: SnackbarProps = useSelector((state: any) => state.snackbar);
