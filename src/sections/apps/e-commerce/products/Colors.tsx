...
// types
import { ColorsOptionsProps } from '@fruity/types/e-commerce';
...
const Color = ({ bg, id, colors, label, handleFilter }: ColorProps) => {
...
const Colors = ({ colors, handleFilter }: { colors: string[]; handleFilter: (type: string, params: string) => void }) => {
