...
// types
import { Products, ProductStateProps, Reviews } from '@fruity/types/e-commerce';

// project imports
import ProductReview from '@fruity/components/cards/e-commerce/ProductReview';
...
import { getProductReviews } from '@fruity/store/reducers/product';

// assets
import { PaperClipOutlined, PictureOutlined, SmileOutlined, StarFilled, StarOutlined } from '@ant-design/icons';
import userItself from '@fruity/assets/images/users/avatar-4.png';
...
const ProductReviews = ({ product }: { product: Products }) => {
  ...
  const productState: ProductStateProps = useSelector((state: any) => state.product);
