...
// types
import { ProductStateProps } from '@fruity/types/e-commerce';
...
import prod1 from '@fruity/assets/images/e-commerce/prod-11.png';
import prod2 from '@fruity/assets/images/e-commerce/prod-22.png';
import prod3 from '@fruity/assets/images/e-commerce/prod-33.png';
import prod4 from '@fruity/assets/images/e-commerce/prod-44.png';
import prod5 from '@fruity/assets/images/e-commerce/prod-55.png';
import prod6 from '@fruity/assets/images/e-commerce/prod-66.png';
import prod7 from '@fruity/assets/images/e-commerce/prod-77.png';
import prod8 from '@fruity/assets/images/e-commerce/prod-88.png';

import prodImage from '@fruity/assets/images/e-commerce/prod-11.png';

// ==============================|| PRODUCT DETAILS - IMAGES ||============================== //

const ProductImages = () => {
  const { product }: ProductStateProps = useSelector((state: any) => state.product);
  ...
  const initialImage = product && product?.image ? prodImage : '';
          ...
          >
            <Slider {...settings}>
              {[11, 22, 33, 44, 55, 66, 77, 88].map((item, index) => (
                <Box key={index} onClick={() => setSelected(prodImage)} sx={{ p: 1 }}>
                  <Avatar
