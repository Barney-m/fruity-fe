...
import { getRelatedProducts } from '@fruity/store/reducers/product';
...
const RelatedProducts = ({ id }: { id?: string }) => {
  ...
  const { relatedProducts }: ProductStateProps = useSelector((state: any) => state.product);
